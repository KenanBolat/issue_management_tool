...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251212134612_AddProgressRequestUpdates")]
    partial class AddProgressRequestUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Configuration", b =>
                {
                    ...
                    b.Property<string>("ExcelDateTimeFormat")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("excel_date_time_format");

                    b.Property<string>("ExcelTimezone")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("excel_timezone");
            ...
            modelBuilder.Entity("Domain.Entities.NotificationAction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.NotificationRead", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.ProgressRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ResponseActionId")
                        .HasColumnType("bigint")
                        .HasColumnName("response_action_id");
                    ...
                    b.ToTable("ProgressRequests");
                });

            modelBuilder.Entity("Domain.Entities.ProgressRequestUpdate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.Ticket", b =>
                {
                    ...
                    b.Property<int?>("ActivityControlStatus")
                        .HasColumnType("integer")
                        .HasColumnName("activity_control_status");
                    ...
                    b.Property<string>("SubContractor")
                        .HasColumnType("text")
                        .HasColumnName("sub_contractor");

                    b.Property<DateTime?>("SubContractorNotifiedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sub_contractor_notified_at");
            ...
            modelBuilder.Entity("Domain.Entities.TicketPause", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("PausedByUserId")
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("ResumeNotes")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("resume_notes");

                    b.Property<DateTime?>("ResumedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("resumed_at");

                    b.Property<long?>("ResumedByUserId")
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("TicketId", "ResumedAt");

                    b.ToTable("ticket_pause");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProgressRequest", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "RespondedBy")
                        .WithMany()
                        .HasForeignKey("RespondedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.TicketAction", "ResponseAction")
                        .WithMany()
                        .HasForeignKey("ResponseActionId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Domain.Entities.ProgressRequestUpdate", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ProgressRequest", "ProgressRequest")
                        .WithMany("Updates")
                        .HasForeignKey("ProgressRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.TicketPause", b =>
                {
                    b.HasOne("Domain.Entities.User", "PausedByUser")
                        .WithMany()
                        .HasForeignKey("PausedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.User", "ResumedByUser")
                        .WithMany()
